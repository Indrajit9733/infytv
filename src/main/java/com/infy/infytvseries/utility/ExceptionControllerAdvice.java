package com.infy.infytvseries.utility;
...
public class ExceptionControllerAdvice {
	...
	private static final Log LOGGER = LogFactory.getLog(ExceptionControllerAdvice.class);
	  ...
	  @ExceptionHandler(SeriesBookingException.class)
	   public ResponseEntity<ErrorInfo>seriesBookingExceptionHandler(SeriesBookingException exception)
	   {
